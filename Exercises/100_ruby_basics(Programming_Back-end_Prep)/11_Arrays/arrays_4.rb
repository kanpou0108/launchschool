...
# Discussion
# 
# In the previous exercise, we learned how to remove an element from an array. 
# Here we do the opposite and add an element to an array using #push. 
# When using #push, you pass in the element you want to add and it will be added to the end of the specified array. 
# In this case, we selected 'dog' from pets and added it to my_pets.
# 
