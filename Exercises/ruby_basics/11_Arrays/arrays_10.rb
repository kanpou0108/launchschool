...
# Discussion
# 
# There's more than one way to compare arrays but perhaps the simplest way is using ==. 
# In the solution, we use == to compare the value of array1 to the value of array2 and print the return value, which is false, with #puts.
# 
