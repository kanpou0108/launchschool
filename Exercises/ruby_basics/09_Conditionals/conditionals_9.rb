...
# Discussion
# This exercise demonstrates a crucial mistake made by beginners: inadvertently using assignment as the condition. 
# This means that instead of evaluating whether number equals 5, we're assigning 5 to number, which always evaluates to 5, which in turn evaluates as true in a conditional expression. That's not what we want.
# 
