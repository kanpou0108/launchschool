...
# 
# The result is quite different. When we were working with a numeric variable, no changes were made to a. 
# This was due to the fact that numbers are immutable, and assignment merely changes the object that a variable references. 
# Now, though, Strings are mutable - they can be modified - and, in particular, the method String#[]= is a mutating method; it actually modifies the string. 
