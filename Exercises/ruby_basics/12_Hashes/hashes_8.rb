...
# Discussion
# 
# In the previous exercise, we used #select without the bang operator (!). This returned a new hash from #select, and left numbers unmodified. 
# Our solution in this exercise uses #select! to modify the hash assigned to numbers and returns a new hash.
# 
# Further Exploration
# 
